            ...
            [sg.Column(layout=[
                ...
                sg.Column(layout=[
                    ...
                    [sg.Input(tooltip="Stop X point",
                              ...
                              pad=pad_input,
                              font=font_input)],
                    [sg.Input(tooltip="Number of intermediate points",
                              default_text='7',
                              justification='center',
                              enable_events=True,
                              key='N',
                              ...
                              pad=pad_input,
                              font=font_input)],
                    [sg.Input(tooltip="Start value of number of intermediate points",
                              default_text='7',
                              justification='center',
                              enable_events=True,
                              key='n0',
                              ...
                              font=font_input,
                              disabled=True)],
                    [sg.Input(tooltip="Stop value of number of intermediate points",
                              default_text='100',
                              justification='center',
                              enable_events=True,
                              key='nf',
